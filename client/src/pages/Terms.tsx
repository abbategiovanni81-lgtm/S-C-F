          ...
          <div className="prose prose-invert max-w-none space-y-8 text-gray-300">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2">
                ...
                <li><strong className="text-white">Studio (£99.99/month):</strong> <span className="text-yellow-400 font-semibold">Early adopter pricing. Limited time.</span> Enterprise tier with Creator Studio included, Steve AI video generation, Getty Images access, all 9 social channels, and 5 concurrent logins.</li>
              </ul>
