...
import { LayoutDashboard, Calendar, BarChart3, Users, Settings, PlusCircle, ChevronLeft, ChevronRight, Cpu, FileText, CheckSquare, Sparkles, Download, Scissors, Headphones, HelpCircle, Shield, Wand2, GitCompare, MessageSquare, Film, Type, BookOpen, Image } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { icon: Image, label: "Image Workshop", href: "/image-workshop" },
