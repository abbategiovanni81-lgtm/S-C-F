...
import { LayoutDashboard, Calendar, BarChart3, Users, Settings, PlusCircle, ChevronLeft, ChevronRight, Cpu, FileText, CheckSquare, Sparkles, Download, Scissors, Headphones, HelpCircle, Shield, Wand2, GitCompare, MessageSquare, Film, Search } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { icon: Search, label: "Content Research", href: "/content-research" },
